...
KARNATAKA_LOCATIONS: dict[str, tuple[float, float, str, str]] = {
    ...
    # Mysuru & District
    "mysuru": (12.3089, 76.6521, "Mysuru City", "Mysuru"),
    "mysore": (12.3089, 76.6521, "Mysuru City", "Mysuru"),
    "devaraja": (12.3101, 76.6535, "Devaraja Mohalla, Mysuru", "Mysuru"),
    "saraswathipuram": (12.3012, 76.6348, "Saraswathipuram, Mysuru", "Mysuru"),
    "kuvempunagar": (12.2856, 76.6289, "Kuvempunagar, Mysuru", "Mysuru"),
    "vv mohalla": (12.3212, 76.6389, "VV Mohalla, Mysuru", "Mysuru"),
    "vontikoppal": (12.3212, 76.6389, "Vontikoppal, Mysuru", "Mysuru"),
    "nazarbad": (12.3065, 76.6698, "Nazarbad, Mysuru", "Mysuru"),
    "nanjangud": (12.1189, 76.6812, "Nanjangud, Mysuru", "Mysuru"),
    "hunsur": (12.3089, 76.2889, "Hunsur", "Mysuru"),
    "periyapatna": (12.3389, 76.0989, "Periyapatna", "Mysuru"),

    # Mandya & Taluks
    "mandya": (12.5248, 76.8989, "Mandya", "Mandya"),
    "srirangapatna": (12.4212, 76.6912, "Srirangapatna, Mandya", "Mandya"),
    "maddur": (12.5841, 77.0439, "Maddur, Mandya", "Mandya"),
    "malavalli": (12.3889, 77.0589, "Malavalli", "Mandya"),
    "pandavapura": (12.5012, 76.6689, "Pandavapura", "Mandya"),
...
PINCODE_LOCATIONS = {
    ...
    "571438": (12.4212, 76.6912, "Srirangapatna (PIN 571438)", "Mandya"),
    "571428": (12.5841, 77.0439, "Maddur (PIN 571428)", "Mandya"),
